...
function QAContent() {
  ...
  useEffect(() => {
    ...
    loadCompanies();
  }, [initialCompanyNumber, setValue, selectedCompanyNumber]);
...
// Fallback component to show while QAContent is loading
function QAFallback() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      <Header />
      <main className="flex-1 py-6">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white shadow sm:rounded-lg flex flex-col h-[calc(100vh-12rem)] items-center justify-center">
            <LoadingSpinner />
            <p className="mt-4 text-gray-600">Loading Q&A interface...</p>
          </div>
        </div>
      </main>
    </div>
